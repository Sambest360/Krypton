      ...
      <section id="pricing" className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground mx-auto max-w-2xl">
              No hidden fees or charges. We believe in complete transparency for all your trades.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="border-2 border-muted">
              <CardContent className="p-6">
                ...
                <p className="text-trading-primary text-3xl font-bold mb-6">Free</p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-trading-success" />
                  ...
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-trading-success" />
                    <span>Limited transactions</span>
                  </li>
                </ul>
                <Link to="/register">
            ...
            <Card className="border-2 border-trading-primary relative">
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-trading-primary text-white px-4 py-1 rounded-full text-sm font-medium">
                Popular
              </div>
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-2">Pro</h3>
                <p className="text-trading-primary text-3xl font-bold mb-6">$19/mo</p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-trading-success" />
            ...
            <Card className="border-2 border-muted">
              <CardContent className="p-6">
                ...
                <p className="text-trading-primary text-3xl font-bold mb-6">Custom</p>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center">
                    <Check size={16} className="mr-2 text-trading-success" />
